...
class DashboardController extends AbstractDashboardController
{
    ...
    {
        return Dashboard::new()->setTitle('ElectivoIA');
    }
    ...
    public function configureMenuItems(): iterable
    {
        ...
        if ($this->isGranted('ROLE_SUPER_ADMIN')) {
            ...
            yield MenuItem::linkToCrud('🏫 Colegios', 'fas fa-school', School::class)
                ->setController(SchoolCrudController::class);
            yield MenuItem::linkToUrl('🚀 Onboarding colegio', 'fas fa-plus-circle', $this->generateUrl('super_admin_onboard'));
            yield MenuItem::linkToUrl('📊 Panel Super Admin', 'fas fa-globe', $this->generateUrl('super_admin_dashboard'));
        }
    }
}
